...
/* package */ final  class TrackSelectionHelper implements View.OnClickListener,
    ...
    private int id;
    private boolean isIconVisibility = false;
    private TrackDetectListenter trackDetectionListener;
    ...
    /**
     * Instance of showing Dialog we calling method to check the subtittle is present or not
     */

    public void updateSubtittle(MappedTrackInfo trackInfo,
                                int rendererIndex, TrackDetectListenter trackDetectionListener) {
        this.trackInfo = trackInfo;
        this.rendererIndex = rendererIndex;
//        if (rendererIndex==1) {
//            trackGroups = trackInfo.getTrackGroups(rendererIndex);
...
//            override = selector.getSelectionOverride(rendererIndex, trackGroups);
        ...
        //  }
        this.trackDetectionListener = trackDetectionListener;
        trackDetectionListener.subTittle(isSubtittle, isIconVisibility);
    ...
    public void onClick(DialogInterface dialog, int which) {
     //   selector.setRendererDisabled(rendererIndex, isDisabled);
        selector.buildUponParameters().setRendererDisabled(rendererIndex, isDisabled);
        if (override != null) {
           // selector.setSelectionOverride(rendererIndex, trackGroups, override);
            selector.buildUponParameters().setSelectionOverride(rendererIndex, trackGroups, override);
        } else {
        //   selector.clearSelectionOverrides(rendererIndex);
           selector.buildUponParameters().clearSelectionOverrides(rendererIndex);
