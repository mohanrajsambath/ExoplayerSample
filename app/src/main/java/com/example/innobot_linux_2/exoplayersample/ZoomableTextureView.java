...
public class ZoomableTextureView extends TextureView {
    ...
    PlaybackControl playBackInstance = null;
    ...
    public ZoomableTextureView(Context context,PlaybackControl instanceOfControl) {
        super(context);
        this.context = context;
        playBackInstance = instanceOfControl;
        initView(null);
    }
    ...
    private class ZoomOnTouchListeners implements OnTouchListener {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            playBackInstance.onClickTexture();
